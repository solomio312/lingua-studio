"""Translation pipeline — orchestrates engines, glossary, progress, and streaming.

Migrated from Calibre plugin lib/translation.py.
Changes:
  - Removed load_translations() (Calibre i18n)
  - Replaced _() calls with plain strings
  - Adjusted imports for lingua package structure
"""
...
from lingua.engines import GoogleFreeTranslateNew
from lingua.engines.base import Base
from lingua.engines.custom import CustomTranslate
...
ENGINE_PRICING = {
    ...
    # Generic Aliases
    'Gemini': {'input': 0.10, 'output': 0.40, 'type': 'token'},
    'Gemini 2.5 Flash Lite': {'input': 0.10, 'output': 0.40, 'type': 'token'},
    'Gemini 2.0 Flash': {'input': 0.10, 'output': 0.40, 'type': 'token'},
    # OpenAI models
...
def estimate_cost(char_count, engine_name, model_name=None):
    ...
    details = f'~${total_cost:.6f} (Input: ${input_cost:.6f} + Output: ${output_cost:.6f})'
    return (total_cost, details, False)


# Translation Styles Mapping (Shared across Settings and Workspace)
TRANSLATION_STYLES = {
    'Literary (Fiction)': 'literary',
    'Romance': 'romance',
    'Thriller/Action': 'thriller',
    'Historical': 'historical',
    'Sci-Fi/Philosophical': 'scifi_philosophical',
    'Business/Economy': 'business',
    'Technical/Crypto': 'technical',
    'Self-Help/Inspirational': 'self_help',
    'Philosophy/Theology': 'philosophy_theology',
    'Technical Writing': 'technical',
    'Editing/Refinement': 'editing',
}
