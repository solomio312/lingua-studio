...
class ClaudeTranslate(GenAI):
    ...
    def get_headers(self):
        headers = {
            ...
            'User-Agent': 'Ebook-Translator/%s' % lingua.__version__,
        }
    ...
    def get_result(self, response: httpx.Response | str) -> str:
        if self.stream:
    ...
    def _parse_stream(self, data: httpx.Response) -> Generator:
        while True:
            try:
